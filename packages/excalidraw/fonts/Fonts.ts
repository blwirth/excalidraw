...
import { HelveticaLightFontFaces } from "./HelveticaLight";
...
export class Fonts {
  ...
  private static init() {
    ...
    // local-only sibling: resolves to "Helvetica Light" on macOS, falls back on other systems
    init("Helvetica Light", ...HelveticaLightFontFaces);
